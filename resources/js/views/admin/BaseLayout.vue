            ...
            <aside class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform" :class="sidebarComputed">
                <div class="h-full px-3 py-4 bg-gray-50 dark:bg-gray-800">
                    ...
                    <ul>
                        ...
                        <li>
                            <router-link :to="{ name: 'Data Tingkat Jurusan Admin' }"
                                         class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                <span class="ml-3">Tingkat & Jurusan</span>
                            </router-link>
                        </li>
                        <li>
                            <router-link :to="{ name: 'Data Kelas Admin' }"
                                         class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div v-show="isLogoutOpen"
        ...
        <div class="bg-white px-16 py-14 rounded-md text-center">
            ...
            <div class="grid grid-cols-2 gap-1">
                <button @click="logout"
                        class="bg-red-500 px-4 py-2 rounded-md text-md font-semibold text-white cursor-pointer">Keluar
                </button>
                <button @click="isLogoutOpen = false"
                        class="bg-gray-500 px-4 py-2 rounded-md text-md font-semibold text-white ml-1 cursor-pointer">
                    Batal
                </button>
            </div>
        </div>

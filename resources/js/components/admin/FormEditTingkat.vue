<template>
    <div class="z-50 bg-slate-800 bg-opacity-50 flex justify-center items-center absolute top-0 right-0 bottom-0 left-0">
        <div class="bg-white dark:bg-gray-900 px-16 py-14 rounded-md">
            ...
            <div class="grid mb-2">
                <div>
                    <label class="block mb-2 text-sm font-medium dark:text-slate-300 text-slate-900">Nama Tingkat</label>
                    <input v-model="dataUpdate.nama_tingkat" type="text"
            ...
            <div class="flex justify-end gap-2">
                ...
                <button @click="formToEditTingkatClose"
...
export default {
    ...
    methods: {
        updateTingkat(){
            axios.put("/api/admin/tingkat/update", {
                id: this.dataUpdate.id,
                tingkat: this.dataUpdate.nama_tingkat,
                _method: "put"
            }, {
                headers: {
        ...
        formToEditTingkatClose(){
            this.$emit('isFormToEditTingkatFalse', false);
        }
    }
}
</script>
